  ...
  useEffect(() => {
    ...
    Axios.get("http://localhost:5000/courses")
      .then((response) => {
        ...
        // Fetch additional data for the first 3 courses (e.g., instructor data)
        const fetchInstructorData = async () => {
          const coursesWithInstructors = await Promise.all(
            first3Courses.map(async (course) => {
    ...
    <>
      <section className="backdrop-image">
        ...
        <div className="backdrop-section">
          <div className="lg:w-1/2 md:w-full">
            <h1 className="lg:text-6xl head-h1 font-bold text-white my-8 ">
      ...
      <section className="">
        <div className="flex p-[40px] popular-top">
          <div className="flex-1">
            ...
            <h1 className="lg:text-5xl head-h1">Popular Courses</h1>
          </div>
            ...
            >
              ...
              <div className="flex flex-col p-5 gap-2">
                <div>
                  ...
                  <p className="mt-3"><span className="text-orange">by:</span> {course.instructorData.firstName} {course.instructorData.lastName}</p>
                </div>
                <div>
                  <button
                    onClick={() => navigate(`/courseInfo/${course._id}`)}
                    className="bg-blue rounded w-full p-1 text-white
                    transition duration-300 ease-in-out hover:bg-orange"
                  >
                    See more...
                  </button>
                </div>
        ...
        <div className="relative z-10 my-10">
          <div className="flex gap-5 exp-blue-sec">
            <div className="flex-1">
              ...
              ></div>
              <h1 className="text-2xl font-bold my-3 head-h1">Experience</h1>
              <p>
            ...
            <div className="flex-1">
              <div
                ...
                style={{ "--skew-angle": "40deg" }}
              ></div>
              <h1 className="text-2xl font-bold my-3 head-h1">Education</h1>
              <p>
                Lorem ipsum dolor sit amet, consec tetur adipis cing elit. Ut
                elit tellus, luctus nec ullam corper mattis, pulvinar dapibus.
              </p>
            ...
            <div className="flex-1">
              <div
                ...
                style={{ "--skew-angle": "40deg" }}
              ></div>
              <h1 className="text-2xl font-bold my-3 head-h1">Certificate</h1>
              <p>
                Lorem ipsum dolor sit amet, consec tetur adipis cing elit. Ut
                elit tellus, luctus nec ullam corper mattis, pulvinar dapibus.
              </p>
            ...
            <div className="bg-white text-black p-5 w-96">
              ...
              <h1 className="lg:text-2xl font-bold my-4 head-h1">
        ...
        <div className="flex choose-us">
          <div className="flex-1">
            <div>
              ...
              <h1 className="lg:text-4xl font-bold my-5 head-h1">Why Choose Us?</h1>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
          ...
          <div className="flex-1 flex flex-col gap-6">
            <div className="flex gap-5">
              ...
              <div>
                <h1 className="text-xl font-bold head-h1">Best Industry Leaders</h1>
                <p>
      ...
      <section className="p-[40px]">
        <div className="flex Testimonials">
          <div className="flex-1">
            <h4>Testimonials</h4>
            <h1 className="lg:text-4xl font-bold my-5 head-h1">
